# 該程式的功能為看該患者是否腸胃有問題(input:圖片,output:0(沒問題) or 1(有問題) )
...
#每張照片的路徑
Path = glob.glob(os.getcwd()+'\data\imagesRGB\*.jpg')
...
for i in Path:
    ...
    # cv2.imwrite('C:/Users/ken82/yolov5/data/imagesTemp/'+basename+'.jpg', grray)
    ...
    if count >=1:
        #這邊選出state 1 跟 0  輸出形式還尚未確定,需要做更多個功能後看怎樣的輸出會比較方便,
        #目前是先print出狀態以及嚴重程度,之後要製作成資料庫或是怎樣再看要怎麼弄
        print(i,"STATE 1")
